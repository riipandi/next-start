  ...
  return (
    <main className='flex min-h-screen flex-col items-center justify-between p-24'>
      ...
      <div className='mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left'>
        ...
        <Link
          href='https://beta.nextjs.org/docs?utm_source=next-start&utm_medium=appdir-template&utm_campaign=next-start'
          className='group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30'
          target='_blank'
          rel='noopener noreferrer'
        >
        ...
        <Link
          href='https://vercel.com/new?utm_source=next-start&utm_medium=appdir-template&utm_campaign=next-start'
          className='group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30'
          target='_blank'
          rel='noopener noreferrer'
        >
