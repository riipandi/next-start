...
import devAnimate from '../assets/images/dev-animate.svg'
      ...
      <div className="flex items-center min-h-screen text-white">
        <div className="container flex flex-wrap items-center p-4 mx-auto">
          <motion.div
            ...
            <Image src={devAnimate} alt="Welcome" />
          </motion.div>
          <div className="w-full p-8 font-sans text-center md:w-7/12 md:text-left md:p-12">
            ...
            <div className="my-4 text-xl font-semibold md:text-3xl">We are still build something amazing for you.</div>
            <div className="mb-8 text-lg md:text-2xl">Nothing to see here yet! Please come back soon.</div>
            <a
              ...
              <ChevronRightIcon className="w-6 h-6 ml-1 -mr-1" />
            </a>
          </div>
        </div>
      </div>
